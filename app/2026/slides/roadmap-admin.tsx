      ...
      <div className="w-full max-w-4xl">
        <ul className="space-y-4 text-base md:text-xl lg:text-2xl">
          ...
          <li className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
            <span className="mt-2 h-2.5 w-2.5 flex-shrink-0 rounded-full bg-pink-500 md:mt-2.5" />
            <a
              href="https://github.com/antiwork/gumroad/issues/2922"
              target="_blank"
              rel="noopener noreferrer"
              className="text-inherit hover:underline"
            >
          ...
          <li className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
            <span className="mt-2 h-2.5 w-2.5 flex-shrink-0 rounded-full bg-pink-500 md:mt-2.5" />
            <a
              href="https://github.com/antiwork/gumroad/issues/2029"
              target="_blank"
              rel="noopener noreferrer"
              className="text-inherit hover:underline"
            >
          ...
          <li className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
            <span className="mt-2 h-2.5 w-2.5 flex-shrink-0 rounded-full bg-pink-500 md:mt-2.5" />
            <a
              href="https://github.com/antiwork/gumroad/issues/3268"
              target="_blank"
              rel="noopener noreferrer"
              className="text-inherit hover:underline"
            >
          ...
          <li className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
            <span className="mt-2 h-2.5 w-2.5 flex-shrink-0 rounded-full bg-pink-500 md:mt-2.5" />
            <a
              href="https://github.com/antiwork/gumroad/issues/1928"
              target="_blank"
              rel="noopener noreferrer"
              className="text-inherit hover:underline"
            >
