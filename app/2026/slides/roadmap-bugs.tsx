      ...
      <div className="grid w-full max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 md:gap-8">
        <div>
          ...
          <ul className="space-y-3 text-base md:text-lg lg:text-xl">
            ...
            <li className="text-gray-700 dark:text-gray-300">
              <a
                href="https://github.com/antiwork/gumroad/issues/2150"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit hover:underline"
              >
        ...
        <div>
          ...
          <ul className="space-y-3 text-base md:text-lg lg:text-xl">
            ...
            <li className="text-gray-700 dark:text-gray-300">
              <a
                href="https://github.com/antiwork/gumroad/issues/3319"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit hover:underline"
              >
            ...
            <li className="text-gray-700 dark:text-gray-300">
              <a
                href="https://github.com/antiwork/gumroad/issues/2756"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit hover:underline"
              >
            ...
            <li className="text-gray-700 dark:text-gray-300">
              <a
                href="https://github.com/antiwork/gumroad/issues/1619"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit hover:underline"
              >
            ...
            <li className="text-gray-700 dark:text-gray-300">
              <a
                href="https://github.com/antiwork/gumroad/issues/3152"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit hover:underline"
              >
            ...
            <li className="text-gray-700 dark:text-gray-300">
              <a
                href="https://github.com/antiwork/gumroad/issues/2995"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit hover:underline"
              >
