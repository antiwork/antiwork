export default function SlideDiscountCode() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center p-4 md:p-8 lg:p-12">
      ...
      <div className="flex max-h-[70vh] w-full max-w-2xl items-center justify-center">
        <video
          autoPlay
          loop
          muted
        ...
        >
          <source
            src="/2025/shipped_features/apply discount code to the product.mp4"
            type="video/mp4"
          />
        </video>
      </div>
